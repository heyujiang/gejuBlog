    ...
    <form class="layui-form" method="POST">
        ...
        <table class="layui-table">
            ...
            <tr>
                <td>标题</td>
                <td>
                    <input type="text" name="title" class="layui-input" lay-verify="required" placeholder="请输公告标题">
                </td>
            </tr>
            <tr>
                <td>正文</td>
            ...
            <tr>
                <td>排序</td>
                <td>
                    <input type="number" name="sort" value="1" class="layui-input" lay-verify="required" placeholder="请输入排序">
                </td>
            </tr>
            <tr>
                <td>显示/隐藏</td>
                <td>
                    <input type="checkbox" name="is_show" value="1" lay-skin="switch" lay-text="显示|隐藏">
                </td>
            </tr>
            </tbody>
        </table>
