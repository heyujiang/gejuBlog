    ...
    <form class="layui-form" method="POST">
        ...
        <table class="layui-table">
            ...
            <tr>
                ...
                <td>
                    <select name="navigation_pid" class="layui-select">
                        ...
                        @foreach($parent_navigations as $parent_navigation)
                            <option value="{{$parent_navigation->navigation_id}}" @if($parent_navigation->navigation_id == $navigation->navigation_pid) selected @endif>{{ $parent_navigation->name }}</option>
                        @endforeach
                    </select>
                </td>
            </tr>
            <tr>
                <td>导航名称</td>
                <td>
                    <input type="text" name="name" class="layui-input" value="{{ $navigation->name }}" lay-verify="required" placeholder="请输导航标题">
                </td>
            </tr>
            <tr>
                <td>链接</td>
                <td>
                    ...
                    <input type="text" name="link" class="layui-input " value="{{ $navigation->link }}" lay-verify="required" placeholder="请输导航链接">
                </td>
            </tr>
            <tr>
                <td>排序</td>
                <td>
                    <input type="number" name="sort" value="{{ $navigation->sort }}" class="layui-input sort-input" lay-verify="required" placeholder="请输入排序">
                </td>
            </tr>
            </tbody>
        </table>
